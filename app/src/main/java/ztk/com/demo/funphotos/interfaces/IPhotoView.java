...
public interface IPhotoView {
     ...
     * @param listener - Listener to be registered.
     */
    void setOnMatrixChangeListener(ZoomPhotoViewAttacher.OnMatrixChangedListener listener);
     ...
     * @param listener - Listener to be registered.
     */
    void setOnPhotoTapListener(ZoomPhotoViewAttacher.OnPhotoTapListener listener);

    /**
     * Returns a listener to be invoked when the Photo displayed by this View is tapped with a
     * single tap.
     *
     * @return ZoomPhotoViewAttacher.OnPhotoTapListener currently set, may be null
     */
    ZoomPhotoViewAttacher.OnPhotoTapListener getOnPhotoTapListener();
     ...
     * @param listener - Listener to be registered.
     */
    void setOnViewTapListener(ZoomPhotoViewAttacher.OnViewTapListener listener);
     ...
     *
     * @return ZoomPhotoViewAttacher.OnViewTapListener currently set, may be null
     */
    ZoomPhotoViewAttacher.OnViewTapListener getOnViewTapListener();
    ...
    /**
     * Allows to change zoom transition speed, default value is 200 (ZoomPhotoViewAttacher.DEFAULT_ZOOM_DURATION).
    ...
    /**
     * Will return instance of IPhotoView (eg. ZoomPhotoViewAttacher), can be used to provide better
     * integration
     *
     ...
     * default, you can just pass in "null" or public field of ZoomPhotoViewAttacher.defaultOnDoubleTapListener
     *
