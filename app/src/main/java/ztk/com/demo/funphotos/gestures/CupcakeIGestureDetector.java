...
public class CupcakeIGestureDetector implements IGestureDetector {

    protected OnGestureListener mListener;
    private static final String LOG_TAG = "CupcakeIGestureDetector";
    float mLastTouchX;
    float mLastTouchY;
    ...
    public CupcakeIGestureDetector(Context context) {
